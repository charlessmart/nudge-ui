...
Run its real-compiler compatibility contract from the repository root:

```sh
pnpm test:compat
```

The data-led contract lives in `src/compatibility-manifest.ts`. Each scenario identifies a
